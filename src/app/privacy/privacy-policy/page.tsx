      ...
      <EntryWrapper>
        ...
        <div>
          ...
          <p className="  ">
            ...
            are only permissible for private, non-commercial use and must not be
            used for direct or indirect financial gain. Unauthorized use of
            copyrighted material is subject to legal penalties (§ 106 of the
            copyright law).
          </p>
          <p className="  mt-4 ">
            I cannot assure the absolute accuracy, completeness, or currentness
            of the contents. As stipulated by legal provisions, I am responsible
            for the content I create. It's important to note that I am not
            obligated to monitor third-party information provided or stored on
            my website, nor am I required to search for circumstances that might
            indicate illicit activities. My responsibilities to remove or block
            the usage of information under universally binding legal standards
            remain unaltered by this, as outlined in §§ 8 to 10 of the Telemedia
            Act (TMG).
          </p>
        </div>
      </EntryWrapper>
